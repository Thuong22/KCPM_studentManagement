...
namespace Transparent_Form
{
    public partial class StudentInCourseForm : Form
    {
        ...
        private void CourseForm_Load(object sender, EventArgs e)
        {
            ...
            cbbStudent.DataSource = course.GetCourseList("SELECT * FROM `account`");
            cbbStudent.DisplayMember = "AccFirstName";
            cbbStudent.ValueMember = "AccId";
        ...
        private void txtSearch_TextChanged(object sender, EventArgs e)
        {
            ...
            if (txt.Text.Length == 0)
                ...
                "WHERE CONCAT(course.CourseName, account.AccFirstName, account.AccLastName)LIKE '%" + txtSearch.Text + "%'");
        }
