    ...
    public partial class AdminForm : Form
    {
       ...
       (
        ...
        private void cbbCourse_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            lbCourseMale.Text = "Male : " + DataProvider.Instance.ExecuteScalar($"SELECT COUNT(*) FROM account INNER JOIN score INNER JOIN course ON account.AccId=score.StudentId AND score.CourseId=course.CourseId WHERE course.CourseName='" + cbbCourse.GetItemText(cbbCourse.SelectedItem) + "' AND `Gender`= 'Male'");
            lbCourseFemale.Text = "Female : " + DataProvider.Instance.ExecuteScalar($"SELECT COUNT(*) FROM account INNER JOIN score INNER JOIN course ON account.AccId=score.StudentId AND score.CourseId=course.CourseId WHERE course.CourseName='" + cbbCourse.GetItemText(cbbCourse.SelectedItem) + "' AND `Gender`= 'Female'");
        }
